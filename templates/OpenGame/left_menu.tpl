...
<tr>
	<td colspan="2" style="border-top: 1px #545454 solid"><div><center>{servername}<br>(<a href="changelog.php" target={mf}><font color=red>{actualVersion}</font></a>)<center></div></td>
</tr><tr>
...
<tr>
	...
	{server_info}
<tr>
	<td colspan="2"><div><center><a href="credit.php" accesskey="T" target="{mf}">Ojuelos Bajos Team</a><br>&copy; Copyright 2009</center></div></td>
</tr>
</table>
</div>
</center>
